	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				content: <>
					<p>Aside from building the base functionality from the e-commerce side, like handling products and categories and things like that, I helped with the planning and architecture of a handful of features (as well as implementation), such as, the integration with the payment processing system and the integration with the delivery service to handle delivering users&apos; purchases.</p>
					<br/>
